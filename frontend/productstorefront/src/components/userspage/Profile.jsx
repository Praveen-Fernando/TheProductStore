          ...
          <dl class="sm:divide-y sm:divide-gray-200">
            <div class="py-3 sm:py-5  sm:gap-4 sm:px-6">
              ...
              <ul class="list-disc list-inside pl-4 mb-6">
                ...
                <li class="mb-2 text-gray-600">
                  Your wishlist and any saved items in your shopping cart.
                </li>
                <li class="mb-2 text-gray-600">
                  Access to any exclusive member discounts, offers, or rewards.
                </li>
                <li class="mb-2 text-gray-600">
                  Any store credits, gift cards, or loyalty points associated
                  with your account.
                </li>
                <li class="mb-2 text-gray-600">
              ...
              <ul class="list-disc list-inside pl-4 mb-6">
                <li class="mb-2 text-gray-600">
                  Ensure you have backed up any important data or information
                  before proceeding.
                </li>
                <li class="mb-2 text-gray-600">
                  Be aware that this action is irreversible and your account
                  cannot be recovered.
                </li>
                <li class="mb-2 text-gray-600">
                  Understand that deleting your account will cancel any active
                  orders and ongoing subscriptions.
                </li>
                <li class="mb-2 text-gray-600">
                  Settle any outstanding payments or obligations prior to
                  account deletion.
                </li>
                <li class="mb-2 text-gray-600">
                  Note that you may lose access to any refunds, credits, or
                  rewards linked to your account.
                </li>
              </ul>

              <p class="text-gray-600">
                If you have any questions or need assistance, please contact our
                customer support team before proceeding.
              </p>
            </div>
          </dl>
          <br />
